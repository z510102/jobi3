...
class CEffectStates : public CBillEffect
{
public:
	typedef enum
	{
	...
	void Draw(void);	// 描画処理
	static CEffectStates *Create(D3DXVECTOR3 pos, D3DXVECTOR3 scale, D3DXVECTOR3 move, int life, int nType);		//エフェクトの生成
